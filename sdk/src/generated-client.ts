...
export type TestTriggerResources =
  | "pod"
  | "deployment"
  | "statefulset"
  | "daemonset"
...
export type TestSourceUpdateRequest =
  | (TestContent & {
      name?: string;
      namespace?: string;
      labels?: {
 ...
 * List test triggers
 */
export function listTestTriggers(
  {
    $namespace,
    selector,
  }: {
...
export function createTestTrigger(
  testTriggerUpsertRequest: TestTriggerUpsertRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 */
export function bulkUpdateTestTriggers(
  body: TestTriggerUpsertRequest[],
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
 ...
 */
export function deleteTestTriggers(
  {
    $namespace,
    selector,
  }: {
 ...
 */
export function getTestTriggerById(
  id: string,
  {
    $namespace,
  }: {
  ...
  >(
    `/triggers/${encodeURIComponent(id)}${QS.query(
      QS.explode({
        namespace: $namespace,
      })
    )}`,
 ...
 * Update test trigger
 */
export function updateTestTrigger(
  id: string,
  testTriggerUpsertRequest: TestTriggerUpsertRequest,
  {
    $namespace,
 ...
 * Delete test trigger
 */
export function deleteTestTrigger(
  id: string,
  {
    $namespace,
  }: {
...
export function createTestSuite(
  testSuiteUpsertRequest: TestSuiteUpsertRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 * Delete test suites
 */
export function deleteTestSuites(
  {
    selector,
  }: {
    selector?: string;
...
export function updateTestSuite(
  id: string,
  testSuiteUpdateRequest: TestSuiteUpdateRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 */
export function getTestSuiteMetrics(
  id: string,
  {
    last,
    limit,
  ...
  >(
    `/test-suites/${encodeURIComponent(id)}/metrics${QS.query(
      QS.explode({
        last,
        limit,
      })
 ...
 */
export function abortTestSuiteExecutions(
  id: string,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
  ...
  >(`/test-suites/${encodeURIComponent(id)}/abort`, {
    ...opts,
    method: "POST",
  });
}
 ...
 */
export function listTestSuiteWithExecutions(
  {
    selector,
    textSearch,
    status,
  ...
  >(
    `/test-suite-with-executions${QS.query(
      QS.explode({
        selector,
        textSearch,
        status,
 ...
 */
export function getTestSuiteByIdWithExecution(
  id: string,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
...
export function executeTestSuite(
  ...
  >(
    `/test-suites/${encodeURIComponent(id)}/executions${QS.query(
      QS.explode({
        namespace: $namespace,
        last,
      })
 ...
 */
export function listTestSuiteExecutions(
  id: string,
  {
    pageSize,
    page,
 ...
 */
export function getTestSuiteExecution(
  id: string,
  executionId: string,
  opts?: Oazapfts.RequestOpts
) {
  ...
  >(
    `/test-suites/${encodeURIComponent(id)}/executions/${encodeURIComponent(
      executionId
    )}`,
    {
      ...opts,
 ...
 */
export function abortTestSuiteExecution(
  id: string,
  executionId: string,
  opts?: Oazapfts.RequestOpts
) {
 ...
 */
export function getTestSuiteExecutionArtifactsByTestsuite(
  id: string,
  executionId: string,
  opts?: Oazapfts.RequestOpts
) {
 ...
 */
export function executeTestSuites(
  testSuiteExecutionRequest: TestSuiteExecutionRequest,
  {
    $namespace,
    selector,
  ...
  >(
    `/test-suite-executions${QS.query(
      QS.explode({
        namespace: $namespace,
        selector,
        concurrency,
 ...
 * Get all test suite executions
 */
export function listAllTestSuiteExecutions(
  {
    last,
    test,
    textSearch,
 ...
 */
export function getTestSuiteExecutionById(
  executionId: string,
  {
    last,
  }: {
  ...
  >(
    `/test-suite-executions/${encodeURIComponent(executionId)}${QS.query(
      QS.explode({
        last,
      })
    )}`,
 ...
 * Aborts testsuite execution
 */
export function abortTestSuiteExecutionById(
  executionId: string,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
 ...
 * Get test suite execution artifacts
 */
export function getTestSuiteExecutionArtifacts(
  executionId: string,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
...
export function downloadFile(
  ...
  >(
    `/executions/${encodeURIComponent(id)}/artifacts/${encodeURIComponent(
      filename
    )}`,
    {
      ...opts,
...
export function downloadArchive(
  ...
  >(
    `/executions/${encodeURIComponent(id)}/artifact-archive${QS.query(
      QS.explode({
        mask,
      })
    )}`,
...
export function createTest(
  testUpsertRequest: TestUpsertRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
...
export function getTestMetrics(
  ...
  >(
    `/tests/${encodeURIComponent(id)}/metrics${QS.query(
      QS.explode({
        last,
        limit,
      })
 ...
 */
export function listTestWithExecutions(
  {
    selector,
    textSearch,
    status,
...
export function executeTest(
  ...
  >(
    `/tests/${encodeURIComponent(id)}/executions${QS.query(
      QS.explode({
        namespace: $namespace,
      })
    )}`,
 ...
 * Get all test executions
 */
export function listTestExecutions(
  id: string,
  {
    last,
    pageSize,
...
export function getTestExecution(
  ...
  >(
    `/tests/${encodeURIComponent(id)}/executions/${encodeURIComponent(
      executionId
    )}`,
    {
      ...opts,
...
export function createExecutor(
  executorUpsertRequest: ExecutorUpsertRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 * Delete executors
 */
export function deleteExecutors(
  {
    selector,
  }: {
    selector?: string;
...
export function updateExecutor(
  id: string,
  executorUpdateRequest: ExecutorUpdateRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 * List test sources
 */
export function listTestSources(
  {
    selector,
  }: {
    selector?: string;
...
export function createTestSource(
  testSourceUpsertRequest: TestSourceUpsertRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 */
export function processTestSourceBatch(
  testSourceBatchRequest: TestSourceBatchRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
 ...
 * Delete test sources
 */
export function deleteTestSources(
  {
    selector,
  }: {
    selector?: string;
 ...
 * Update test source
 */
export function updateTestSource(
  id: string,
  testSourceUpdateRequest: TestSourceUpdateRequest,
  opts?: Oazapfts.RequestOpts
) {
  return oazapfts.fetchJson<
    | {
