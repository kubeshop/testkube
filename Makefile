...
LD_FLAGS += -X github.com/kubeshop/testkube/pkg/analytics.testkubeMeasurementID=$(ANALYTICS_TRACKING_ID) -X github.com/kubeshop/testkube/pkg/analytics.testkubeApiSecret=$(ANALYTICS_API_SECRET)
