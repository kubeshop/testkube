...
func (r *SlackLoader) Load() (listeners common.Listeners, err error) {
	// TODO(emil): this loader is not necessary this ready is just in the constructor of the notifier, can just use the register command to avoid calling this on every reconcilation
