...
func NewProxyAPIClient(client kubernetes.Interface, config APIConfig) APIClient {
	return APIClient{
		...
		TestWorkflowClient:         NewTestWorkflowClient(NewProxyClient[testkube.TestWorkflow](client, config)),
...
func NewDirectAPIClient(httpClient *http.Client, sseClient *http.Client, apiURI, apiPathPrefix string) APIClient {
	return APIClient{
		...
		TestWorkflowClient:         NewTestWorkflowClient(NewDirectClient[testkube.TestWorkflow](httpClient, apiURI, apiPathPrefix)),
...
func NewCloudAPIClient(httpClient *http.Client, sseClient *http.Client, apiURI, apiPathPrefix string) APIClient {
	return APIClient{
		...
		TestWorkflowClient:         NewTestWorkflowClient(NewCloudClient[testkube.TestWorkflow](httpClient, apiURI, apiPathPrefix)),
