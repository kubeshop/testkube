...
const (
	...
	END_TESTWORKFLOW_TEST_FAILURE_EventType           EventType = "end-testworkflow-test-failure"
	END_TESTWORKFLOW_INFRASTRUCTURE_FAILURE_EventType EventType = "end-testworkflow-infrastructure-failure"
	END_TESTWORKFLOW_CONFIGURATION_ERROR_EventType    EventType = "end-testworkflow-configuration-error"
