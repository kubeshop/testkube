...
//
//	mockgen -source=./testsources.go -destination=./mock_testsources.go -package=testsources github.com/kubeshop/testkube/pkg/operator/client/testsources/v1 Interface
//
