...
//go:generate go tool mockgen -source=./rest.go -destination=./mock_rest.go -package=tests "github.com/kubeshop/testkube/pkg/operator/client/tests/v3" RESTInterface
