...
//go:generate go tool mockgen -destination=./mock_webhooks.go -package=executors "github.com/kubeshop/testkube/pkg/operator/client/executors/v1" WebhooksInterface
