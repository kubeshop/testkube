...
func TestSQLCTestWorkflowExecutionQueries_CountTestWorkflowExecutions(t *testing.T) {
	...
	// Mock expected result - CountTestWorkflowExecutions returns a single count
	...
	// Execute query
	result, err := queries.CountTestWorkflowExecutions(ctx, CountTestWorkflowExecutionsParams{
		OrganizationID:     "org-id",
		EnvironmentID:      "env-id",
		WorkflowName:       "",
		WorkflowNames:      []string{},
