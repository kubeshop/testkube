...
// IsMuted checks if the workflow has muted set to true in its execution schema
func (e *IntermediateExecution) IsMuted() bool {
	if e.cr == nil {
		return false
	}
	...
	if e.cr.Spec.Execution.Muted == nil {
		return false
	}
	return *e.cr.Spec.Execution.Muted
}
