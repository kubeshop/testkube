...
func ListArtifacts(getClient GetClientFn) (tool mcp.Tool, handler server.ToolHandlerFunc) {
...
func ReadArtifact(getClient GetClientFn) (tool mcp.Tool, handler server.ToolHandlerFunc) {
