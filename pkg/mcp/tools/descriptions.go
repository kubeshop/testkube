...
'failed', 'skipped', 'aborted', 'timeout', 'paused'`
	...
	StartDateDescription = "Filter executions scheduled on or after this date/time. Accepts a date (YYYY-MM-DD, e.g., '2024-01-15') or a full RFC 3339 timestamp with time (e.g., '2024-01-15T13:00:00Z'). Use the timestamp form to narrow results to a specific hour range within a day."

	EndDateDescription = "Filter executions scheduled on or before this date/time. Accepts a date (YYYY-MM-DD, e.g., '2024-01-31') which includes the entire day, or a full RFC 3339 timestamp (e.g., '2024-01-31T16:00:00Z') for an exact upper bound. Combine with startDate to express ranges like 'yesterday 1–4 PM'."
