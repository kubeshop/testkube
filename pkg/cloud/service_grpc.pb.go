...
type TestKubeCloudAPIClient interface {
	...
	UpdateAgentCapabilitiesOnStartup(ctx context.Context, in *UpdateAgentCapabilitiesOnStartupRequest, opts ...grpc.CallOption) (*UpdateAgentCapabilitiesOnStartupResponse, error)
...
func (c *testKubeCloudAPIClient) UpdateAgentCapabilitiesOnStartup(ctx context.Context, in *UpdateAgentCapabilitiesOnStartupRequest, opts ...grpc.CallOption) (*UpdateAgentCapabilitiesOnStartupResponse, error) {
	out := new(UpdateAgentCapabilitiesOnStartupResponse)
	err := c.cc.Invoke(ctx, "/cloud.TestKubeCloudAPI/UpdateAgentCapabilitiesOnStartup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testKubeCloudAPIClient) GetGitHubToken(ctx context.Context, in *GetGitHubTokenRequest, opts ...grpc.CallOption) (*GetGitHubTokenResponse, error) {
	out := new(GetGitHubTokenResponse)
	err := c.cc.Invoke(ctx, "/cloud.TestKubeCloudAPI/GetGitHubToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testKubeCloudAPIClient) ListExecutionArtifactsPresigned(ctx context.Context, in *ListExecutionArtifactsPresignedRequest, opts ...grpc.CallOption) (*ListExecutionArtifactsPresignedResponse, error) {
	out := new(ListExecutionArtifactsPresignedResponse)
	err := c.cc.Invoke(ctx, "/cloud.TestKubeCloudAPI/ListExecutionArtifactsPresigned", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestKubeCloudAPIServer interface {
	...
	UpdateAgentCapabilitiesOnStartup(context.Context, *UpdateAgentCapabilitiesOnStartupRequest) (*UpdateAgentCapabilitiesOnStartupResponse, error)
...
func (UnimplementedTestKubeCloudAPIServer) UpdateAgentCapabilitiesOnStartup(context.Context, *UpdateAgentCapabilitiesOnStartupRequest) (*UpdateAgentCapabilitiesOnStartupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAgentCapabilitiesOnStartup not implemented")
}
...
func (UnimplementedTestKubeCloudAPIServer) ListExecutionArtifactsPresigned(context.Context, *ListExecutionArtifactsPresignedRequest) (*ListExecutionArtifactsPresignedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListExecutionArtifactsPresigned not implemented")
}
...
func _TestKubeCloudAPI_UpdateAgentCapabilitiesOnStartup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateAgentCapabilitiesOnStartupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestKubeCloudAPIServer).UpdateAgentCapabilitiesOnStartup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.TestKubeCloudAPI/UpdateAgentCapabilitiesOnStartup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestKubeCloudAPIServer).UpdateAgentCapabilitiesOnStartup(ctx, req.(*UpdateAgentCapabilitiesOnStartupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TestKubeCloudAPI_GetGitHubToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGitHubTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestKubeCloudAPIServer).GetGitHubToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.TestKubeCloudAPI/GetGitHubToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestKubeCloudAPIServer).GetGitHubToken(ctx, req.(*GetGitHubTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TestKubeCloudAPI_ListExecutionArtifactsPresigned_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListExecutionArtifactsPresignedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestKubeCloudAPIServer).ListExecutionArtifactsPresigned(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.TestKubeCloudAPI/ListExecutionArtifactsPresigned",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestKubeCloudAPIServer).ListExecutionArtifactsPresigned(ctx, req.(*ListExecutionArtifactsPresignedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TestKubeCloudAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateAgentCapabilitiesOnStartup",
			Handler:    _TestKubeCloudAPI_UpdateAgentCapabilitiesOnStartup_Handler,
		},
		{
		...
		{
			MethodName: "ListExecutionArtifactsPresigned",
			Handler:    _TestKubeCloudAPI_ListExecutionArtifactsPresigned_Handler,
		},
		{
