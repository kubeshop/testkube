...
type TestWorkflowParallelStepNotificationsRequest struct {
	...
	StreamId          string                               `protobuf:"bytes,1,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"`
	ExecutionId       string                               `protobuf:"bytes,2,opt,name=execution_id,json=executionId,proto3" json:"execution_id,omitempty"`
	ParallelStepName  string                               `protobuf:"bytes,3,opt,name=parallel_step_name,json=parallelStepName,proto3" json:"parallel_step_name,omitempty"`
	ParallelStepIndex int32                                `protobuf:"varint,4,opt,name=parallel_step_index,json=parallelStepIndex,proto3" json:"parallel_step_index,omitempty"`
	RequestType       TestWorkflowNotificationsRequestType `protobuf:"varint,5,opt,name=request_type,json=requestType,proto3,enum=cloud.TestWorkflowNotificationsRequestType" json:"request_type,omitempty"`
}
...
func (x *TestWorkflowParallelStepNotificationsRequest) GetParallelStepName() string {
	if x != nil {
		return x.ParallelStepName
	}
	return ""
}

func (x *TestWorkflowParallelStepNotificationsRequest) GetParallelStepIndex() int32 {
	if x != nil {
		return x.ParallelStepIndex
	}
	return 0
}
...
var file_proto_service_proto_rawDesc = []byte{
	...
	0x9c, 0x02, 0x0a, 0x2c, 0x54, 0x65, 0x73, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
	...
	0x12, 0x2c, 0x0a, 0x12, 0x70, 0x61, 0x72, 0x61, 0x6c, 0x6c, 0x65, 0x6c, 0x5f, 0x73, 0x74, 0x65,
	0x70, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x70, 0x61,
	0x72, 0x61, 0x6c, 0x6c, 0x65, 0x6c, 0x53, 0x74, 0x65, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2e,
	0x0a, 0x13, 0x70, 0x61, 0x72, 0x61, 0x6c, 0x6c, 0x65, 0x6c, 0x5f, 0x73, 0x74, 0x65, 0x70, 0x5f,
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x11, 0x70, 0x61, 0x72,
	0x61, 0x6c, 0x6c, 0x65, 0x6c, 0x53, 0x74, 0x65, 0x70, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x4e,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x48, 0x0a, 0x15, 0x4c, 0x6f, 0x67, 0x73, 0x53,
	...
	0x5f, 0x4f, 0x55, 0x54, 0x50, 0x55, 0x54, 0x10, 0x03, 0x2a, 0x4c, 0x0a, 0x06, 0x4f, 0x70, 0x63,
	...
	0x43, 0x48, 0x45, 0x43, 0x4b, 0x10, 0x03, 0x32, 0x88, 0x07, 0x0a, 0x10, 0x54, 0x65, 0x73, 0x74,
...
var file_proto_service_proto_goTypes = []interface{}{
	...
	(*CredentialResponse)(nil),                            // 17: cloud.CredentialResponse
	(*TestWorkflowServiceNotificationsRequest)(nil),       // 18: cloud.TestWorkflowServiceNotificationsRequest
	(*TestWorkflowServiceNotificationsResponse)(nil),      // 19: cloud.TestWorkflowServiceNotificationsResponse
	(*TestWorkflowParallelStepNotificationsRequest)(nil),  // 20: cloud.TestWorkflowParallelStepNotificationsRequest
	(*TestWorkflowParallelStepNotificationsResponse)(nil), // 21: cloud.TestWorkflowParallelStepNotificationsResponse
	nil,                     // 22: cloud.ExecuteRequest.HeadersEntry
	nil,                     // 23: cloud.ExecuteResponse.HeadersEntry
	(*structpb.Struct)(nil), // 24: google.protobuf.Struct
	(*emptypb.Empty)(nil),   // 25: google.protobuf.Empty
}
var file_proto_service_proto_depIdxs = []int32{
	0,  // 0: cloud.LogsStreamRequest.request_type:type_name -> cloud.LogsStreamRequestType
	24, // 1: cloud.CommandRequest.payload:type_name -> google.protobuf.Struct
	22, // 2: cloud.ExecuteRequest.headers:type_name -> cloud.ExecuteRequest.HeadersEntry
	...
	23, // 6: cloud.ExecuteResponse.headers:type_name -> cloud.ExecuteResponse.HeadersEntry
	...
	13, // 12: cloud.ExecuteRequest.HeadersEntry.value:type_name -> cloud.HeaderValue
	13, // 13: cloud.ExecuteResponse.HeadersEntry.value:type_name -> cloud.HeaderValue
	14, // 14: cloud.TestKubeCloudAPI.Execute:input_type -> cloud.ExecuteResponse
	15, // 15: cloud.TestKubeCloudAPI.Send:input_type -> cloud.WebsocketData
	6,  // 16: cloud.TestKubeCloudAPI.Call:input_type -> cloud.CommandRequest
	14, // 17: cloud.TestKubeCloudAPI.ExecuteAsync:input_type -> cloud.ExecuteResponse
	5,  // 18: cloud.TestKubeCloudAPI.GetLogsStream:input_type -> cloud.LogsStreamResponse
	10, // 19: cloud.TestKubeCloudAPI.GetTestWorkflowNotificationsStream:input_type -> cloud.TestWorkflowNotificationsResponse
	19, // 20: cloud.TestKubeCloudAPI.GetTestWorkflowServiceNotificationsStream:input_type -> cloud.TestWorkflowServiceNotificationsResponse
	21, // 21: cloud.TestKubeCloudAPI.GetTestWorkflowParallelStepNotificationsStream:input_type -> cloud.TestWorkflowParallelStepNotificationsResponse
	...
	8,  // 24: cloud.TestKubeCloudAPI.Execute:output_type -> cloud.ExecuteRequest
	25, // 25: cloud.TestKubeCloudAPI.Send:output_type -> google.protobuf.Empty
	7,  // 26: cloud.TestKubeCloudAPI.Call:output_type -> cloud.CommandResponse
	8,  // 27: cloud.TestKubeCloudAPI.ExecuteAsync:output_type -> cloud.ExecuteRequest
	4,  // 28: cloud.TestKubeCloudAPI.GetLogsStream:output_type -> cloud.LogsStreamRequest
	9,  // 29: cloud.TestKubeCloudAPI.GetTestWorkflowNotificationsStream:output_type -> cloud.TestWorkflowNotificationsRequest
	18, // 30: cloud.TestKubeCloudAPI.GetTestWorkflowServiceNotificationsStream:output_type -> cloud.TestWorkflowServiceNotificationsRequest
	20, // 31: cloud.TestKubeCloudAPI.GetTestWorkflowParallelStepNotificationsStream:output_type -> cloud.TestWorkflowParallelStepNotificationsRequest
	11, // 32: cloud.TestKubeCloudAPI.GetProContext:output_type -> cloud.ProContextResponse
	17, // 33: cloud.TestKubeCloudAPI.GetCredential:output_type -> cloud.CredentialResponse
