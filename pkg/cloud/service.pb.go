...
type UpdateAgentCapabilitiesOnStartupRequest struct {
	...
	// Runner-supplied registration metadata refreshed on every startup. Honored only when
	// `update_registration_metadata` is true so older runners (which leave the new fields
	// unset) keep getting their previous capabilities-only behavior.
	Labels                     map[string]string `protobuf:"bytes,2,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	UpdateRegistrationMetadata bool              `protobuf:"varint,5,opt,name=update_registration_metadata,json=updateRegistrationMetadata,proto3" json:"update_registration_metadata,omitempty"`
}
...
func (x *UpdateAgentCapabilitiesOnStartupRequest) GetUpdateRegistrationMetadata() bool {
	if x != nil {
		return x.UpdateRegistrationMetadata
	}
	return false
}
...
var file_service_proto_rawDesc = []byte{
	...
	0x0a, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xf6, 0x02, 0x0a, 0x27,
	...
	0x73, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x12, 0x40, 0x0a, 0x1c, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1a, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x39, 0x0a, 0x0b, 0x4c, 0x61, 0x62,
