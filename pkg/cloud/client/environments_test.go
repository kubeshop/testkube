...
func TestEnvironmentsClient_Create(t *testing.T) {
	...
	t.Run("error on response", func(t *testing.T) {
		...
		o.Client = ClientMock{err: http.ErrNoLocation, validateRequestFunc: func(req *http.Request) error { return nil }}
	...
	t.Run("create org", func(t *testing.T) {
		...
		o.Client = ClientMock{body: []byte(resp), validateRequestFunc: func(r *http.Request) error {
