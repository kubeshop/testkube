...
func NewCopyFilesPlacer(endpoint, accessKeyID, secretAccessKey, region, token, bucket string, ssl bool) *CopyFilesPlacer {
	c := minio.NewClient(endpoint, accessKeyID, secretAccessKey, region, token, bucket, ssl)
