...
//go:generate go tool mockgen -destination=./mock_extractor.go -package=scrapertypes "github.com/kubeshop/testkube/pkg/executor/scraper/scrapertypes" Extractor
