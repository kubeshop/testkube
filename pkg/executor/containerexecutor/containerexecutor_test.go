...
func TestNewExecutorJobSpecWithArgs(t *testing.T) {
	...
	wantEnvs := []corev1.EnvVar{
		{Name: "DEBUG", Value: ""},
		{Name: "RUNNER_STORAGE_ENDPOINT", Value: ""},
		{Name: "RUNNER_STORAGE_ACCESSKEYID", Value: ""},
		{Name: "RUNNER_STORAGE_SECRETACCESSKEY", Value: ""},
		{Name: "RUNNER_STORAGE_REGION", Value: ""},
		{Name: "RUNNER_STORAGE_TOKEN", Value: ""},
		{Name: "RUNNER_STORAGE_BUCKET", Value: ""},
		{Name: "RUNNER_STORAGE_SSL", Value: "false"},
		{Name: "RUNNER_STORAGE_SKIP_VERIFY", Value: "false"},
		{Name: "RUNNER_STORAGE_CERT_FILE", Value: ""},
		{Name: "RUNNER_STORAGE_KEY_FILE", Value: ""},
		{Name: "RUNNER_STORAGE_CA_FILE", Value: ""},
		...
		{Name: "RUNNER_AGENT_INSECURE", Value: "false"},
		{Name: "RUNNER_AGENT_SKIP_VERIFY", Value: "false"},
		{Name: "RUNNER_AGENT_CERT_FILE", Value: ""},
		{Name: "RUNNER_AGENT_KEY_FILE", Value: ""},
		{Name: "RUNNER_AGENT_CA_FILE", Value: ""},
