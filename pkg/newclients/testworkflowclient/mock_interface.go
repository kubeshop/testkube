...
func (m *MockTestWorkflowClient) DeleteByLabels(arg0 context.Context, arg1 string, arg2 map[string]string) error {
	m.ctrl.T.Helper()
...
func (m *MockTestWorkflowClient) List(arg0 context.Context, arg1 string, arg2 map[string]string) ([]testkube.TestWorkflow, error) {
	m.ctrl.T.Helper()
