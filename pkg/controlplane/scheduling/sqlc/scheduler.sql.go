...
WHERE id = $3::text RETURNING id, name, namespace, number, test_workflow_execution_name, group_id, runner_id, runner_target, runner_original_target, disable_webhooks, tags, running_context, config_params, scheduled_at, assigned_at, status_at, created_at, updated_at, organization_id, environment_id, runtime, silent_mode, workflow_name, status, lineage_base_id, lineage_root_id, lineage_attempt
`
