...
###################################
FROM --platform=$BUILDPLATFORM golang:1.27.1-alpine AS builder-init
...
###################################
FROM --platform=$BUILDPLATFORM golang:1.27.1-alpine AS builder-toolkit
...
## Debug builder (Delve)
###################################
FROM golang:1.27.1-alpine AS debug-builder
