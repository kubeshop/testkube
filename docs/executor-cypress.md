...
TestKube makes running Cypress tests simple. As Cypress is organised in projects, tests can be defined in a Github repository (for now, only a public repository is implemented).
