...
## Usage
Before staring switch your curent folder to /contrib/executor/pytest
...
### Step 2 - Build executor Docker image
...
And now run the test to see if you're using failed and passed results.
