...
**That's the new, and recommended way of running custom images. Docs about the legacy way of creating custom executors can be found [here](legacy-executor.md).**
