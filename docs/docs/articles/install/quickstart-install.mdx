...
Once installed, you will be asked if you want to `testkube dashboard port-forward` to conveniently access all relevant services on your localhost. You can always execute this yourself afterwards should you close this terminal after installation. The admin in this demo has the following e-mail and password: `admin@example.com/password`.
