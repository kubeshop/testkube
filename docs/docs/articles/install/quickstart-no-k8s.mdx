...
Local evaluation of Testkube requires you to have access to a Kubernetes cluster, which is either running locally on your machine or
...
That's it! Now you can go to the [Testkube Quickstart](quickstart.mdx) and pick up from there!
