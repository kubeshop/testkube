...
To set them up when using Testkube, you'll need to create your _Webhook_ as shown in the following format example (you can use https://webhooks.site to create a webhook to test with):
...
Running a Test should trigger the webhook and you should in your webhook endpoint an event like this:
