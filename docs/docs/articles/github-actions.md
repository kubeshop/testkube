...
The Testkube GitHub Action installs Testkube and enables running any [Testkube CLI](https://docs.testkube.io/cli/testkube) command in a GitHub workflow. It is available on Github Marketplace as [Testkube Action](https://github.com/marketplace/actions/testkube-action).
