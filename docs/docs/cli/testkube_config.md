...
* [testkube config dashboard-name](testkube_config_dashboard-name.md)	 - Set dashboard name for testkube client
* [testkube config dashboard-port](testkube_config_dashboard-port.md)	 - Set dashboard port for testkube client
