...
func NewRunTestWorkflowCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVarP(&selectors, "label", "l", nil, "label expression to select test worklows to run using key value pair: --label key1=value1 or label expression")
