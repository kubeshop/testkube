...
func NewRunTestWorkflowCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if watchEnabled {
				ui.NL()
				result, err := watchTestWorkflowLogs(execution.Name, execution.Signature, client) // TODO(TKC-1652): Use execution.Id when will be replaced
	...
	cmd.Flags().StringToStringVarP(&config, "env", "", map[string]string{}, "configuration variables in a form of name1=val1 passed to executor")
