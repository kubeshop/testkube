...
func AddCreateFlags(cmd *cobra.Command, flags *CreateCommonFlags) {
	...
	cmd.Flags().BoolVarP(&flags.ArtifactSidecarScraper, "artifact-sidecar-scraper", "", false, "whether to run a scraper as a pod sidecar container")
