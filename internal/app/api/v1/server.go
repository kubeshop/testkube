...
func NewTestkubeAPI(
	...
	if s.Executor, err = client.NewJobExecutor(executionsResults, testExecutionsResults, s.Namespace, initImage, s.jobTemplates.Job, s.Metrics, s.EventsEmitter); err != nil {
		panic(err)
	}
